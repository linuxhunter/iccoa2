...
import com.example.iccoa2.apdu.CommandApduEnable
import com.example.iccoa2.apdu.ResponseApduEnable
...
class ApduEnableUnitTest {
    @Test
    fun create_enable_request() {
        val request = CommandApduEnable().apply {
            this.cla = 0x00u
    ...
    @Test
    fun deserialize_enable_request() {
    ...
    @Test
    fun create_enable_response() {
        val response = ResponseApduEnable().apply {
    ...
    @Test
    fun deserialize_enable_response() {
        val buffer: UByteArray = ubyteArrayOf(
            0x90u, 0x00u,
        )
        val response = ResponseApduEnable().apply {
